...
export default async (req) => {
  ...
  if (body.action === 'load') {
    ...
    if (!/^(index|szemelyi-edzes-gymtronic-gyor|kulteri-szemelyi-edzes-gyor|paros-edzes-gyor|elso-alkalom|szemelyi-edzes-arak-gyor|foglalas|adatkezeles|aszf|impresszum|koszonjuk|404)\.html$/.test(path)) {
  ...
  const ALLOWED = /^((index|szemelyi-edzes-gymtronic-gyor|kulteri-szemelyi-edzes-gyor|paros-edzes-gyor|elso-alkalom|szemelyi-edzes-arak-gyor|foglalas|adatkezeles|aszf|impresszum|koszonjuk|404)\.html|img\/[A-Za-z0-9._-]+)$/;
